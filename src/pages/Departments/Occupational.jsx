...
const Occupational = () => {
  ...
  const sections = [
    ...
    {
      title: 'benefitsOccupational',
      items: [
        'benefitsOccupational1',
        'benefitsOccupational2',
        'benefitsOccupational3',
        'benefitsOccupational4',
        'benefitsOccupational5',
  ...
  return (
    <>
      ...
      >
        <img
          src="src/assets/Deparments/sign1.jpeg" // Replace with the path to your image
      ...
      >
       <Typography
        ...
        >
          {t('occupationalBottomLine')}
        </Typography>
        <Typography variant="body1" sx={{ fontWeight: '500', color: '#800080' }}>
          {t('mail')}: occupationaltherapist<br/>@pcmcdivyangbhavan.org
        </Typography>
