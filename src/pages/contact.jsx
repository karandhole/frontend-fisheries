    ...
    <Container maxWidth="md" sx={{ mt: 5, pb: 10, pt: 5 }}>
      {alertData.message && (
        <CustomAlert
          ...
          onClose={() => setAlertData({ ...alertData, message: null })}
            ...
            <Box mt={2}>
              ...
              >
                {isLoading.message && (
                  <CircularProgress
                    size={24}
                    sx={{ position: "absolute", top: "20%", left: "45%" }}
                  />
                )}
                {t("sendMessage")}
              </Button>
        ...
        <Paper elevation={3} sx={{ p: 3, flex: 1 }}>
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText primary="+919604810938, +918007182510 1800 268 2890 (TollFree) " />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <EmailIcon />
