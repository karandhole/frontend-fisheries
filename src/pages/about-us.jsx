...
import img from '../assets/Deparments/image8.jpg'
...
const BackgroundImageSection = styled(Box)(({ theme }) => ({
  ...
  backgroundImage: `url(${image5})`,  // Replace with your image
...
const ExecutiveSection = styled(Box)(({ theme }) => ({
  ...
  const directors = [
    {
      name: 'director1',
      designation: 'designaton1',
      image: DIR1,  // Replace with actual profile image URL
    },
    {
      name: 'director2',
      designation: 'designaton2',
      image: DIR2,
    },
    {
      name: 'director3',
      designation: 'designaton3',
      image: DIR3,
    },
    {
      name: 'director4',
...
const executiveCommittee = [
    ...
    { title: 'ec1', designation: 'ecDesignation1' },
   
    { title: 'ec2', designation: 'ecDesignation2' },
    { title: 'ec3', designation: 'ecDesignation3' },
    { title: 'ec4', designation: 'ecDesignation4' },
   
    { title: 'ec5', designation: 'ecDesognation5' },
  ];

  const advisors = [
    { name: 'ab1', designation: 'abDesignation1', email: 'deanpgiycmh@pcmcindia.gov.in' },
    { name: 'ab2', designation: 'abDesignation2', email: 'vijaykanhekar@gmail.com' },
    { name: 'ab3', designation: 'abDesignation3', email: 'designbridgepune@gmail.com' },
    { name: 'ab4', designation: 'abDesignation4', email: 'anusanket@gmail.com' },
    { name: 'ab5', designation: 'abDesignation5', email: 'dhananjay.bhole@gmail.com' },
    { name: 'ab6', designation: 'abDesignation6', email: 'sanjay.jain@nls.ac.in' },
    { name: 'ab7', designation: 'abDesignation7', email: 'kalyani.mandke@gmail.com' },
    { name: 'ab8', designation: 'abDesignation8', email: 'bijurns@gmail.com' },
    { name: 'ab9', designation: 'abDesignation9', email: 'bobadesuvarna13@gmail.com' },
    { name: 'ab10', designation: 'abDesignation10', email: 'balkalyansanstha@gmail.com' },
    { name: 'ab11', designation: 'abDesignation11', email: 'advisor11@example.com' },
    { name: 'ab12', designation: 'abDesignation12', email: '' },
  ];
          ...
          <DirectorCard key={index}>
            ...
            <CardContent>
              <Typography variant="h5">
                {t(director.name)}  {/* Use the name from the data */}
              </Typography>
              <Typography variant="h6" color="text.secondary" >
                {t(director.designation)}  {/* Use the designation from the data */}
              </Typography>
            </CardContent>
          </DirectorCard>
        ))}
...
<ExecutiveSection>
  {executiveCommittee.map((member, index) => (
    <CommitteeCard key={index}>
      <Typography variant="h5" sx={{ color: 'white' }}>{t(member.title)}</Typography>
...
<Box sx={{ textAlign: 'center', marginTop: 5 }}>
  ...
  <Typography variant="h5">{t('director3')}</Typography>
  <Typography variant="h6">{t('ecDesignation1')}</Typography>
</Box>
          ...
          {advisors.slice(0, 6).map((advisor, index) => (
            <Accordion key={index} expanded={expanded === index} onChange={handleChange(index)}>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography variant="h5">{t(advisor.name)}</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography variant="h6">{t(advisor.designation)}</Typography>
